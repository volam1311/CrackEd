...
SYSTEM_PROMPT = (
    ...
    "natural topic boundaries and propose a clickbait-style title for each "
    "resulting segment that appeals to short-form audiences.\n\n"
    "Rules:\n"
    ...
    "  'The One Line of Code Everyone Gets Wrong' (curiosity gap)\n"
    "  \"Bet You Can't Explain This Without Googling\" (dare)\n"
    "  \"You've Been Using Loops Wrong This Whole Time\" (mistake warning)\n"
    "  \"Recursion vs Loops: There's Only One Right Answer\" (comparison)\n"
    "  'POV: You Just Found Out What a Hash Map Actually Does' (POV)\n"
    "  \"The Algorithm Trick Senior Devs Don't Explain\" (forbidden knowledge)\n"
    "  '3 Things About Pointers That Will Change How You Code' (numbered list)\n"
